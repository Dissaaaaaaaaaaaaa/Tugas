                    ...
                    <?php foreach ($pembayaran as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="?action=pembayaran&subaction=delete&id=<?= $row['id_pembayaran'] ?>" class="del" onclick="return confirm('Apakah Anda yakin ingin menghapus pembayaran ini?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
